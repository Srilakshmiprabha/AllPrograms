...
public class Calendareg {
	...
	public static void main(String[] args) {
		...
		int mini = calendar.getMinimum(Calendar.DAY_OF_WEEK);
		System.out.println("Maximum number of days in week: " + mini);
		mini = calendar.getMinimum(Calendar.WEEK_OF_YEAR);
		System.out.println("Maximum number of weeks in year: " + mini);
		calendar.set(Calendar.YEAR, 4050);
	}
}
